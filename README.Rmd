...
`snake_to()` will also clean up ggplot *x* and *y* axes. Pipe the saved ggplot object into `snake_to()` and it will clean up snake case titles. There is also an options for `ggplot_title`; when true this will create a title on the plot "Relation Between *x* and *y*".
